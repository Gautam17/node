...
* [[`744f59a44e`](https://github.com/nodejs/node/commit/744f59a44e)] - **async_hooks**: don't abort unnecessarily (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`4611660c9f`](https://github.com/nodejs/node/commit/4611660c9f)] - **async_hooks**: improve comments and function names (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
...
* [[`7a0d4f6977`](https://github.com/nodejs/node/commit/7a0d4f6977)] - **async_wrap**: unroll unnecessarily DRY code (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`009a921f64`](https://github.com/nodejs/node/commit/009a921f64)] - **async_wrap**: return undefined if domain is disposed (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`4f4efb9b87`](https://github.com/nodejs/node/commit/4f4efb9b87)] - **benchmark**: add default configs to buffer benchmark (Rich Trott) [#15175](https://github.com/nodejs/node/pull/15175)
...
* [[`8b1bbe3a59`](https://github.com/nodejs/node/commit/8b1bbe3a59)] - **buffer**: fix MAX_LENGTH constant export (Anna Henningsen) [#14821](https://github.com/nodejs/node/pull/14821)
...
* [[`6c69920f2d`](https://github.com/nodejs/node/commit/6c69920f2d)] - **build**: display HTTP2 configure --help options (Daniel Bevenius) [#15198](https://github.com/nodejs/node/pull/15198)
...
* [[`c916c1cc23`](https://github.com/nodejs/node/commit/c916c1cc23)] - **deps**: cherry-pick 5005faed5 from V8 upstream (Miguel Martins) [#15177](https://github.com/nodejs/node/pull/15177)
* [[`5e15e60af7`](https://github.com/nodejs/node/commit/5e15e60af7)] - **deps**: cherry-pick 1aead19 from upstream V8 (Ben Noordhuis) [#15184](https://github.com/nodejs/node/pull/15184)
* [[`5ce569c223`](https://github.com/nodejs/node/commit/5ce569c223)] - **deps**: upgrade libuv to 1.14.1 (cjihrig) [#14866](https://github.com/nodejs/node/pull/14866)
...
* [[`ff73bbab28`](https://github.com/nodejs/node/commit/ff73bbab28)] - **doc**: add ESM doc to _toc.md and all.md (Vse Mozhet Byt) [#15248](https://github.com/nodejs/node/pull/15248)
* [[`32158a2bd7`](https://github.com/nodejs/node/commit/32158a2bd7)] - **doc**: fix Error property markdown level (Sam Roberts) [#15247](https://github.com/nodejs/node/pull/15247)
* [[`63da499c6b`](https://github.com/nodejs/node/commit/63da499c6b)] - **doc**: add missing space in test/README.md (Vse Mozhet Byt) [#15278](https://github.com/nodejs/node/pull/15278)
* [[`f7b59edf82`](https://github.com/nodejs/node/commit/f7b59edf82)] - **doc**: document bytes to chars after setEncoding (Jessica Quynh Tran) [#13442](https://github.com/nodejs/node/pull/13442)
* [[`ca3c4a0ddd`](https://github.com/nodejs/node/commit/ca3c4a0ddd)] - **doc**: describe what security issues are (Sam Roberts) [#14485](https://github.com/nodejs/node/pull/14485)
* [[`5f6577dbeb`](https://github.com/nodejs/node/commit/5f6577dbeb)] - **doc**: add options argument to crypto docs (Adina Shanholtz) [#14846](https://github.com/nodejs/node/pull/14846)
* [[`a64c776152`](https://github.com/nodejs/node/commit/a64c776152)] - **doc**: instructions for generating coverage reports (Simon Brewster) [#15190](https://github.com/nodejs/node/pull/15190)
* [[`d6f25eb5b2`](https://github.com/nodejs/node/commit/d6f25eb5b2)] - **doc**: clarify async/asynchronous in deprecations.md (Rich Trott) [#15172](https://github.com/nodejs/node/pull/15172)
...
* [[`8f18cc1881`](https://github.com/nodejs/node/commit/8f18cc1881)] - **doc,lib,src,test**: strip executable bits off files (Anna Henningsen) [#15132](https://github.com/nodejs/node/pull/15132)
...
* [[`560ef9778a`](https://github.com/nodejs/node/commit/560ef9778a)] - **errors**: remove duplicated ERR_HTTP_INVALID_STATUS_CODE error (Jon Moss) [#15003](https://github.com/nodejs/node/pull/15003)
...
* [[`2fefa7c973`](https://github.com/nodejs/node/commit/2fefa7c973)] - **http2**: set decodeStrings to false, test (Anatoli Papirovski) [#15140](https://github.com/nodejs/node/pull/15140)
* [[`7748b165cf`](https://github.com/nodejs/node/commit/7748b165cf)] - **http2**: use session not socket timeout, tests (Anatoli Papirovski) [#15188](https://github.com/nodejs/node/pull/15188)
* [[`69462d888b`](https://github.com/nodejs/node/commit/69462d888b)] - **http2**: add compat trailers, adjust multi-headers (Anatoli Papirovski) [#15193](https://github.com/nodejs/node/pull/15193)
* [[`2ae9d68f99`](https://github.com/nodejs/node/commit/2ae9d68f99)] - **http2**: fix closedCode NaN, increase test coverage (Anatoli Papirovski) [#15154](https://github.com/nodejs/node/pull/15154)
* [[`d75b657f2e`](https://github.com/nodejs/node/commit/d75b657f2e)] - **http2**: guard against destroyed session, timeouts (James M Snell) [#15106](https://github.com/nodejs/node/pull/15106)
* [[`e35a2ff814`](https://github.com/nodejs/node/commit/e35a2ff814)] - **http2**: correct emit error in onConnect, full tests (Anatoli Papirovski) [#15080](https://github.com/nodejs/node/pull/15080)
* [[`d64f682828`](https://github.com/nodejs/node/commit/d64f682828)] - **http2**: adjust error types, test coverage (Anatoli Papirovski) [#15109](https://github.com/nodejs/node/pull/15109)
...
* [[`c417ceb148`](https://github.com/nodejs/node/commit/c417ceb148)] - **(SEMVER-MINOR)** **inspector**: enable async stack traces (Miroslav Bajtoš) [#13870](https://github.com/nodejs/node/pull/13870)
* [[`cf195cccb1`](https://github.com/nodejs/node/commit/cf195cccb1)] - **inspector**: rewrite inspector test helper (Eugene Ostroukhov) [#14797](https://github.com/nodejs/node/pull/14797)
* [[`5cb81bdc7c`](https://github.com/nodejs/node/commit/5cb81bdc7c)] - **inspector**: log exceptions in message handlers (Eugene Ostroukhov) [#14980](https://github.com/nodejs/node/pull/14980)
* [[`d538b2544e`](https://github.com/nodejs/node/commit/d538b2544e)] - **lib**: remove circular reference (Ruben Bridgewater) [#14885](https://github.com/nodejs/node/pull/14885)
...
* [[`56b4fbbc91`](https://github.com/nodejs/node/commit/56b4fbbc91)] - **(SEMVER-MINOR)** **module**: Allow runMain to be ESM (Bradley Farias) [#14369](https://github.com/nodejs/node/pull/14369)
* [[`f9a5017b4e`](https://github.com/nodejs/node/commit/f9a5017b4e)] - **n-api**: implement napi_run_script (Gabriel Schulhof) [#15216](https://github.com/nodejs/node/pull/15216)
...
* [[`b63c8af52f`](https://github.com/nodejs/node/commit/b63c8af52f)] - **perf_hooks**: fix presumed typo in node_perf.cc (Anna Henningsen) [#15019](https://github.com/nodejs/node/pull/15019)
* [[`f6c49aca99`](https://github.com/nodejs/node/commit/f6c49aca99)] - **perf_hooks**: mark as experimental (James M Snell) [#14997](https://github.com/nodejs/node/pull/14997)
* [[`5f15572b37`](https://github.com/nodejs/node/commit/5f15572b37)] - **(SEMVER-MINOR)** **perf_hooks**: implementation of the perf timing API (James M Snell) [#14680](https://github.com/nodejs/node/pull/14680)
...
* [[`b841c9e883`](https://github.com/nodejs/node/commit/b841c9e883)] - **promises**: more robust stringification (Timothy Gu) [#13784](https://github.com/nodejs/node/pull/13784)
...
* [[`19f4486562`](https://github.com/nodejs/node/commit/19f4486562)] - **src**: fix compiler warnings in node_perf.cc (Daniel Bevenius) [#15112](https://github.com/nodejs/node/pull/15112)
* [[`920a758b57`](https://github.com/nodejs/node/commit/920a758b57)] - **src**: remove unused persistent properties from env (Anna Henningsen) [#15096](https://github.com/nodejs/node/pull/15096)
* [[`64262c4291`](https://github.com/nodejs/node/commit/64262c4291)] - **src**: fix build on certain platforms (Anna Henningsen) [#14996](https://github.com/nodejs/node/pull/14996)
* [[`a02823cf00`](https://github.com/nodejs/node/commit/a02823cf00)] - **src**: reduce code duplication (James M Snell) [#14937](https://github.com/nodejs/node/pull/14937)
* [[`d5819db874`](https://github.com/nodejs/node/commit/d5819db874)] - **src**: fixup strings, reduce duplication (James M Snell) [#14937](https://github.com/nodejs/node/pull/14937)
* [[`4ff0358b16`](https://github.com/nodejs/node/commit/4ff0358b16)] - **src**: miscellaneous cleanups for node_config (James M Snell) [#14868](https://github.com/nodejs/node/pull/14868)
* [[`8fbd341932`](https://github.com/nodejs/node/commit/8fbd341932)] - **src**: fix DEBUG_HTTP2 type arguments (Daniel Bevenius) [#15197](https://github.com/nodejs/node/pull/15197)
...
* [[`5c7731ae69`](https://github.com/nodejs/node/commit/5c7731ae69)] - **test**: split test-cli-node-options (Refael Ackermann) [#14195](https://github.com/nodejs/node/pull/14195)
* [[`d2499cae50`](https://github.com/nodejs/node/commit/d2499cae50)] - **test**: remove envPlus, use Object.assign everywhere (Gibson Fahnestock) [#14845](https://github.com/nodejs/node/pull/14845)
* [[`a83b6e679f`](https://github.com/nodejs/node/commit/a83b6e679f)] - **test**: fix flaky test-readline-interface (Rich Trott) [#15066](https://github.com/nodejs/node/pull/15066)
* [[`9af55053d2`](https://github.com/nodejs/node/commit/9af55053d2)] - **test**: continue normalizing fixtures use (Miguel Angel Asencio Hurtado) [#14716](https://github.com/nodejs/node/pull/14716)
* [[`7fcc350de6`](https://github.com/nodejs/node/commit/7fcc350de6)] - **(SEMVER-MINOR)** **test**: fix inspector helper port sniffing (Timothy Gu) [#13870](https://github.com/nodejs/node/pull/13870)
* [[`3f44989b24`](https://github.com/nodejs/node/commit/3f44989b24)] - **test**: preserve env in test cases (Beth Griggs) [#14822](https://github.com/nodejs/node/pull/14822)
* [[`ac459c3c75`](https://github.com/nodejs/node/commit/ac459c3c75)] - **test**: exclude write-coverage from coverage report (Benjamin Coe) [#15194](https://github.com/nodejs/node/pull/15194)
* [[`63c542ad88`](https://github.com/nodejs/node/commit/63c542ad88)] - **test**: use no-save and no-package-lock flags (Simon Brewster) [#15196](https://github.com/nodejs/node/pull/15196)
* [[`3bf3067502`](https://github.com/nodejs/node/commit/3bf3067502)] - **test**: add http2 compat setTimeout tests (Anatoli Papirovski) [#15156](https://github.com/nodejs/node/pull/15156)
* [[`704faa1f94`](https://github.com/nodejs/node/commit/704faa1f94)] - **test**: add test-benchmark-buffer (Rich Trott) [#15175](https://github.com/nodejs/node/pull/15175)
* [[`1b457a9bb2`](https://github.com/nodejs/node/commit/1b457a9bb2)] - **test**: refactor test-fs-readfile-unlink (Rich Trott) [#15173](https://github.com/nodejs/node/pull/15173)
* [[`04d2ff0092`](https://github.com/nodejs/node/commit/04d2ff0092)] - **test**: http2 test coverage for NghttpError (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`f258002e31`](https://github.com/nodejs/node/commit/f258002e31)] - **test**: http2 test coverage for assertValidPseudoHeader (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`567c2804f6`](https://github.com/nodejs/node/commit/567c2804f6)] - **test**: http2 test coverage for updateOptionsBuffer (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`9858755a7c`](https://github.com/nodejs/node/commit/9858755a7c)] - **test**: increase Http2ServerResponse test coverage (Anatoli Papirovski) [#15074](https://github.com/nodejs/node/pull/15074)
...
* [[`35bd43f24f`](https://github.com/nodejs/node/commit/35bd43f24f)] - **test,doc**: make module name match gyp target name (Gabriel Schulhof) [#15209](https://github.com/nodejs/node/pull/15209)
* [[`c3e4c128b9`](https://github.com/nodejs/node/commit/c3e4c128b9)] - **test,process**: run 'abort' suite on Windows (Refael Ackermann) [#15056](https://github.com/nodejs/node/pull/15056)
* [[`dfdb6190b6`](https://github.com/nodejs/node/commit/dfdb6190b6)] - **timers**: fix outdated comment (Tim Costa) [#14314](https://github.com/nodejs/node/pull/14314)
* [[`2114c034ad`](https://github.com/nodejs/node/commit/2114c034ad)] - **(SEMVER-MINOR)** **tls**: multiple PFX in createSecureContext (Yury Popov) [#14793](https://github.com/nodejs/node/pull/14793)
...
* [[`0146903760`](https://github.com/nodejs/node/commit/0146903760)] - **vm**: support parsing a script in a specific context (Timothy Gu) [#14888](https://github.com/nodejs/node/pull/14888)
